...
export const HomeSection = () => {
	return (
		<section
			id="home"
			className=" w-screen m-0 px-7 pt-7 space-y-2 grid grid-cols-1 lg:justify-items-stretch lg:px-32 lg:place-items-center lg:grid-cols-2 lg:grid-rows-5 lg:h-[calc(min(100vh-80px))] "
		>
